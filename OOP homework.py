...
student_1 = Student('Alex', 'Smirnov', 'M')
student_1.finished_courses = ['Python', 'C++']
student_1.courses_in_progress = ['Git', 'Java.Script']

student_2 = Student('Alina', 'Malkina', 'W')
student_2.finished_courses = ['С++', 'Git']
student_2.courses_in_progress = ['Python', 'Java.Script']
students_list = [student_1, student_2]

lecturer_1 = Lecturer('Petr', 'Sergeev')
lecturer_1.courses_attached = ['Git', 'Java.Script']

lecturer_2 = Lecturer('Polina', 'Zvereva')
lecturer_2.courses_attached = ['Python']
lecturer_list = [lecturer_1, lecturer_2]

reviewer_1 = Reviewer('Sergei', 'Ivanov')
reviewer_1.courses_attached = ['Python', 'С++', 'Java.Script', 'Git']

reviewer_2 = Reviewer('Vladimir', 'Petrov')
...
reviewer_1.rate_hw(student_1, 'Java.Script', 6)
reviewer_1.rate_hw(student_1, 'Java.Script', 7)
reviewer_1.rate_hw(student_1, 'Java.Script', 10)
...
reviewer_1.rate_hw(student_1, 'С++', 5)
...
reviewer_2.rate_hw(student_2, 'Java.Script', 3)
reviewer_2.rate_hw(student_2, 'Java.Script', 6)
reviewer_2.rate_hw(student_2, 'Java.Script', 4)

student_1.rate_lecturer(lecturer_1, 'Git', 4)
student_1.rate_lecturer(lecturer_1, 'Git', 6)
student_1.rate_lecturer(lecturer_1, 'Git', 7)
student_1.rate_lecturer(lecturer_1, 'Java.Script', 5)
student_1.rate_lecturer(lecturer_1, 'Java.Script', 8)
student_1.rate_lecturer(lecturer_1, 'Java.Script', 6)

student_2.rate_lecturer(lecturer_1, 'Java.Script', 4)
student_2.rate_lecturer(lecturer_1, 'Java.Script', 5)
student_2.rate_lecturer(lecturer_1, 'Java.Script', 9)
...
print(f'Средняя оценка студентов по курсу "Java.Script": {grades_students(students_list, "Java.Script")}')
...
print(f'Средняя оценка лекторов по курсу "Java.Script": {grades_lecturers(lecturer_list, "Java.Script")}')
